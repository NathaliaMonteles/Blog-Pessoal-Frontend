...
import loginLogo from '../../assets/new-york.jpg'
...
function Perfil() {
  ...
  return (
    <div className='container mx-auto mt-4 rounded-2xl overflow-hidden'>
      ...
      <div className="relative mt-[-6rem] h-72 flex flex-col bg-pink-800 text-white text-2xl items-center justify-center">
